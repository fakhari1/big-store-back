            ...
            <section class="row">
                ...
                <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
                    <section class="mb-2"><a href="#" class="d-block"><img class="w-100 rounded-2"
                                                                           src="../../assets/images/slideshow/12.gif"
                                                                           alt=""></a></section>
                    <section class="mb-2"><a href="#" class="d-block"><img class="w-100 rounded-2"
                                                                           src="../../assets/images/slideshow/11.jpg"
                                                                           alt=""></a></section>
                </section>
            </section>
        </section>
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-name"><h3>گوشی موبایل شیائومی مدل POCO X3
                                                            Pro M2102J20SG دو ...</h3></section>
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-colors"></section>
                                                    <section class="product-name"><h3>گوشی موبایل سامسونگ مدل Galaxy A32
                                                            SM-A325F/DS دو ...</h3></section>
                                                    <section class="product-price-wrapper">
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-name"><h3>کیف هندزفری جانتا مدل 141مجموعه 3
                                                            عددی</h3></section>
                                                    <section class="product-price-wrapper">
                                                        <section class="product-discount">
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-colors"></section>
                                                    <section class="product-name"><h3>گوشی موبایل شیائومی مدل POCO M3
                                                            M2010J19CG دو سیم‌...</h3></section>
                                                    <section class="product-price-wrapper">
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-colors"></section>
                                                    <section class="product-name"><h3>گوشی موبایل سامسونگ مدل Galaxy
                                                            A21S SM-A217F/DS دو...</h3></section>
                                                    <section class="product-price-wrapper">
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-colors"></section>
                                                    <section class="product-name"><h3>کیف رودوشی چرم جانتا مدل D078</h3>
                                                    </section>
                                                    <section class="product-price-wrapper">
                                                        <section class="product-discount">
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-colors"></section>
                                                    <section class="product-name"><h3>گوشی موبایل سامسونگ مدل Galaxy A12
                                                            SM-A125F/DS دو ...</h3></section>
                                                    <section class="product-price-wrapper">
            ...
            <section class="container-xxl">
                ...
                <section class="row py-4">
                    <section class="col-12 col-md-6 mt-2 mt-md-0"><img class="d-block rounded-2 w-100"
                                                                       src="../../assets/images/ads/two-col-1.jpg"
                                                                       alt=""></section>
                    <section class="col-12 col-md-6 mt-2 mt-md-0"><img class="d-block rounded-2 w-100"
                                                                       src="../../assets/images/ads/two-col-2.jpg"
                                                                       alt=""></section>
                </section>
                                        ...
                                        <section class="lazyload-item-wrapper">
                                            <section class="product">
                                                ...
                                                <a class="product-link" href="#">
                                                    ...
                                                    <section class="product-colors"></section>
                                                    <section class="product-name"><h3>کتاب اٍر مرکب اثر دارن هاردی با کد
                                                            87</h3></section>
                                                    <section class="product-price-wrapper">
            ...
            <section class="container-xxl">
                ...
                <section class="row py-4">
                    <section class="col"><img class="d-block rounded-2 w-100"
                                              src="../../assets/images/ads/one-col-1.jpg" alt=""></section>
                </section>
                                ...
                                <section class="item">
                                    <section class="brand-item">
                                        <a href="#"><img class="rounded-2"
                                                         src="../../assets/images/brand/parskhazar.png" alt=""></a>
                                    </section>
                                </section>
                                <section class="item">
                                    <section class="brand-item">
