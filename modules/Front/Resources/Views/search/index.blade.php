                ...
                <main id="main-body" class="main-body col-md-9">
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        <section class="filters mb-3">
                            ...
                            <span class="d-inline-block border p-1 rounded bg-light">قیمت از : <span class="badge bg-info text-dark">25,000 ریال</span></span>
                            <span class="d-inline-block border p-1 rounded bg-light">قیمت تا : <span class="badge bg-info text-dark">360,000 ریال</span></span>
                                ...
                                <section class="product">
                                    ...
                                    <a class="product-link" href="#">
                                        ...
                                        <section class="product-price-wrapper">
                                            <section class="product-price">56,000 ریال</section>
                                        </section>
                                    </a>
                                </section>
                            </section>
