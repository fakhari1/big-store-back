...
{{--                                    </section>--}}
                                    ...
                                    <section class="address-select">
                                        ...
                                        @if(count($user->addresses))
                                            ...
                                            @foreach($user->addresses as $key => $address)
                                                ...
                                                <label for="a1" class="address-wrapper mb-2 p-2">
                                                    ...
                                                    <span
                                                        class="address-selected">کالاها به این آدرس ارسال می شوند</span>
                                                </label>


                                                <section class="address-add-wrapper">
                                                    <button class="address-add-button" type="button"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#add-address"><i class="fa fa-plus"></i>
                                                        ایجاد
                                                        آدرس جدید
                                                    </button>
                                                                    ...
                                                                    <form class="row" action="#">
                                                                        <section class="col-6 mb-2">
                                                                            ...
                                                                            <select class="form-select form-select-sm"
                                                                                    id="province">
                                                                                <option selected>استان را انتخاب کنید
                                                                                </option>
                                                                        ...
                                                                        <section
                                                                            class="border-bottom mt-2 mb-3"></section>
                                        ...
                                        @else
                                            <div class="row">
                                                <h5>آدرسی برای شما ثبت نشده است؛ از طریق پنل کاربری خودتان یک آدرس بسازید یا متن آدرس مورد نظر را کامل در کادر زیر وارد کنید</h5>
                                                <div class="form-group">
                                                    <label for="address_text">متن آدرس را کامل وارد کنید:</label>
                                                    <input type="text" id="address_text"
                                                           class="form-control form-control-sm" name="address_text">
                                                </div>
                                            </div>
                                        @endif
                                    </section>
                            ...
                            <section class="col-md-3">
                                <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                    ...
                                    <section class="">
                                        ...
                                        <a id="next-level" href="payment.html" class="btn btn-danger d-none">ادامه
                                            فرآیند خرید</a>
                                    </section>
