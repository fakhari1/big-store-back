                            ...
                            <section class="col-md-9">
                                <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                    ...
                                    <section class="address-select">
                                        ...
                                        @if(count($user->addresses))
                                            ...
                                            @foreach($user->addresses as $key => $address)
                                                ...
                                                <label for="address-{{ $address->id }}"
                                                       class="address-wrapper mb-2 p-2">
                                                    <section class="mb-2">
                                        ...
                                        @else
                                            <div class="row">
                                                <h5>آدرسی برای شما ثبت نشده است؛ از طریق پنل کاربری خودتان یک آدرس ثبت
                                                    کنید</h5>
                                            </div>
                                        @endif
                                    </section>
                                        ...
                                        @foreach($deliveryMethods as $key => $deliver)
                                            ...
                                            <label for="d-{{ $deliver }}"
                                                ...
                                                <section class="mb-2">
                                                    ...
                                                    تامین کالا از
                                                    {{ convertEnglishToPersian($deliver->delivery_time) }}
                                                    {{ $deliver->delivery_time_unit }}
                                                    کاری آینده
                                                </section>
                                            </label>
                                        @endforeach
