                    ...
                    <section class="col">
                        ...
                        <section class="row mt-4">
                            <section class="col-md-9">
                                <form id="profile_completion" action="{{ route('users.profile.update') }}" method="post"
                                    ...
                                    <section class="payment-alert alert alert-primary d-flex align-items-center p-2"
                                        ...
                                        <section>
                                            اطلاعات حساب کاربری خود را (فقط یک بار، برای همیشه) وارد کنید. از این پس
                                            کالاها برای شخصی با این مشخصات ارسال می شود.
                                        </section>
                                    </section>
