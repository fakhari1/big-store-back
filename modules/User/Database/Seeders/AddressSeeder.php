...
class AddressSeeder extends Seeder
{
    ...
    public function run()
    {
        $defaultAddresses = [
            ...
            [
                'vendor_id' => 1,
                'text' => 'اصفهان، بلوار کاوه، خیابان آل محمد، کوچه شفق، مجتمع پزشکی سهروردی 10',
                'mobile' => '9134567810',
            ],
            [
                'vendor_id' => 2,
                'text' => 'اصفهان، بلوار کاوه، خیابان آل محمد، کوچه شفق، مجتمع پزشکی سهروردی 11',
                'mobile' => '9134567811',
            ],
            [
                'vendor_id' => 3,
                'text' => 'اصفهان، بلوار کاوه، خیابان آل محمد، کوچه شفق، مجتمع پزشکی سهروردی 12',
                'mobile' => '9134567812',
            ],
